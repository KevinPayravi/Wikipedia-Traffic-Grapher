...
<div class="container">
	<div class="row">
		<div class="three columns">
			...
			<br>
			<select id="date">
				<option selected="selected" value="201412">December '14</option>
